...
JSONObject sendJson;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.collectionhistoryactivity);
ImageView toolbar_back=(ImageView)findViewById(R.id.toolbar_back);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            while (orderlistkeys.hasNext()) {
                                ...
                                orderCollectionBean.setAmount(orderJObject.getString("payment_status"));
    ...
    void set(ArrayList<OrderCollectionBean> cartListBeanArrayList) {
        CollectionFragmentAdapter  fAdapter = new CollectionFragmentAdapter(this,"history",cartListBeanArrayList,recyclerView);
