...
public class LocationMonitoringService extends Service implements
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location != null) {
            ...
            update_location(String.valueOf(location.getLatitude()), String.valueOf(location.getLongitude()));
    ...
    public  void update_location(String lat,String lng)
    {
        ...
        try
        {
            ...
            sendJson.put("id", SavePref.getPref(LocationMonitoringService.this,
                    SavePref.User_id));
