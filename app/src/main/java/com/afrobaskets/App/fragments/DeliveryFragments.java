...
public class DeliveryFragments extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.deliverdfragments, container, false);
    ...
    void getData(final Context context) {
        ...
        try {
            ...
            sendJson.put("order_status", "out_for_collection");
    ...
    void set(ArrayList<OrderCollectionBean> cartListBeanArrayList) {
        fAdapter = new CollectionFragmentAdapter(getActivity(),"collected",cartListBeanArrayList, recyclerView);
